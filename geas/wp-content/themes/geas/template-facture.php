...
<div class="wrap_facture">
    ...
    ?>
    <div class="float2">
        <div class="logo"><img src="<?php echo get_template_directory_uri(); ?>/img/geas.png"></div>
    ...
    <div class="descriptif">
        ...
        <p class="desc_details2">Taux/horaires</p>
        <p class="desc_details"><?php echo $nomClient->nom_Client ?></p>
        <p class="desc_details2"><?php echo $factures->nom_entreprise ?></p>
        <p class="desc_details2">Nombre de repas</p>
    </div>
    <div class="montant">
        <h4 class="montant_float"><?php $heure = $heures->totalfin - $heures->totaldebut; $totalheure = $heure / 10000; echo $totalheure;?></h4>
        <h4 class="montant_float"><?php echo $tarifs->prix_horaire ?></h4>
        <h4 class="montant_float"><?php $total = $tarifs->prix_horaire * $totalheure; echo $total; ?></h4>
        <h4 class="montant_float"><?php echo $heures->totalrepas ?></h4>
        <h4 class="montant_float"><?php echo $tarifs->prix_repas ?></h4>
        <h4 class="montant_float"><?php $total2 = $tarifs->prix_repas * $heures->totalrepas; echo $total2; ?></h4>
    </div>
    <div class="clear"></div>
    <div class="sous_total">
        <p class="sous_total_float">Sous Total : <?php $resultat = $total + $total2; echo $resultat ?> €</p>
    </div>
    <div class="banderole">
        <p class="total_p">Reste à payer pour cette facture : <?php $resultat = $total + $total2; echo $resultat ?> €</p>
        <p class="total_p2">TOTAL FACTURE : <?php $resultat = $total + $total2; echo $resultat ?> €</p>
    </div>
    <div class="float5">
    ...
    <div class="bas_page">
        ...
        <div class="coupondet2">
            <h3 class="coupdetail">Date : <?php $datetime = date("d/m/Y");
                echo $datetime; ?></h3>
            <h3 class="coupdetail">TOTAL FACTURE : <?php $resultat = $total + $total2; echo $resultat ?> €</h3>
        </div>
    </div>
</div>
<script
